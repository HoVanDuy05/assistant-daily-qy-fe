...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 py-8">
          ...
          <Paper className="p-8 w-full bg-slate-900/60 backdrop-blur-xl border border-slate-700/50 rounded-2xl shadow-2xl shadow-indigo-500/10">
            ...
            <Box className="text-center mb-8">
              ...
              <Typography className="text-slate-400 mt-2 text-sm">
                Bắt đầu hành trình với QY Smart Assistant
              </Typography>
            </Box>
